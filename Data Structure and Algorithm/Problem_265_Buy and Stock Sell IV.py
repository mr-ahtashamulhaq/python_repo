...
class Solution:
    ...
    def maxProfit(self, k, prices) -> int:
        return self.recursion(0, 1, prices, k)
    ...
    # USING TABULATION
    def maxProfit_tabu(self, k, prices) -> int:
    ...
    def maxProfit_tabuSpaceOpt(self, k, prices) -> int:
...
print(obj.maxProfit_memo(k, prices))
print(obj.maxProfit_tabu(k, prices))
print(obj.maxProfit_tabuSpaceOpt(k, prices))
