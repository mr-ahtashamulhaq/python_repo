"""Given a Binary Search Tree (BST) and a key, find the inorder predecessor and inorder successor of the key in the BST.

The predecessor of a node is the node with the largest value smaller than key.

The successor of a node is the node with the smallest value larger than key.

If the predecessor or successor does not exist, return None for that."""
class Node:
