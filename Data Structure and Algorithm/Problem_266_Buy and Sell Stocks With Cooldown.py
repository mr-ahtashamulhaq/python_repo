...
class Solution:
    ...
    def recursion(self, index, buy_choice, prices):
        ...
        else:  # cannot buy exactly after sell so instead moving to next move next's next where you can buy again
            sell = prices[index] + self.recursion(index + 2, 1, prices)
    ...
    def memoization(self, index, buy_choice, prices, dp):
        ...
        if buy_choice == 1:  # mean it can buy
            ...
            sell = prices[index] + self.memoization(index + 2, 1, prices, dp)
    ...
    def maxProfit_tabuSpaceOpt(self, prices) -> int:
        ...
        # ahead1 = dp[index+1], ahead2 = dp[index+2]
        ahead1 = [0, 0]
        ahead2 = [0, 0]
        ...
        for index in range(n - 1, -1, -1):
            ...
            for buy_choice in range(2):
                if buy_choice == 1:  # can buy
                    buy = -prices[index] + ahead1[0]
                    not_buy = ahead1[1]
